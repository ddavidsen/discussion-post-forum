...
/*******
 * <p> Title: GUIRemoveUserPage Class. </p>
 * 
...
public class ViewDeleteUser {
	...
	*/
	...
	// Pop-up Alert windows depending on user action
	protected static Alert cantDeleteAlert = new Alert(AlertType.INFORMATION);
	protected static Alert deleteUserAlert = new Alert(AlertType.CONFIRMATION);
	...
	public static Scene theRemoveUserScene = null;	// The Scene each invocation populates
	...
	*/
	...
	public ViewDeleteUser() {
		...
		theRemoveUserScene = new Scene(theRootPane, width, height);
		...
		// GUI Area 2b
		setupButtonUI(button_DeleteUser, "Dialog", 18, 210, Pos.CENTER, 300, 450);
		...
		// Alert setup
		deleteUserAlert.getButtonTypes().setAll(ButtonType.YES, ButtonType.NO);
