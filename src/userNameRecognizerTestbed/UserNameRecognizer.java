...
public class UserNameRecognizer {
	...
	public static String checkForValidUserName(String input) {
		...
		while (running) {
			...
			case 0: 
				...
				if ((currentChar >= 'A' && currentChar <= 'Z' ) ||		// Check for A-Z
						...
						// no numeric char allowed (deleted this line)
					nextState = 1;
			...
			case 1: 
				...
				// ., _, or -, then -> State 2                     // (added below) Check for valid symbols (_, -, .)
		...
		case 2:
			...
			userNameRecognizerErrorMessage +=
				"A UserName character after an accepted symbol must be A-Z, a-z, 0-9.\n";
			return userNameRecognizerErrorMessage;
