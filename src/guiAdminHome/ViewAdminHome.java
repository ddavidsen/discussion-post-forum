...
public class ViewAdminHome {
	...
	*/
	...
	public static void displayAdminHome(Stage ps, User user) {
		...
		// Update GUI Area 2 in case any users were added/deleted or invitaions were made
	...
	private ViewAdminHome() {
		...
		button_ViewRequests.setOnAction((event) -> 
			{ControllerAdminHome.viewAdminRequests(); });
		
		setupButtonUI(button_CloseRequest, "Dialog", 16, 210, Pos.CENTER, 570, 130);
		button_CloseRequest.setOnAction((event) -> 
			{ControllerAdminHome.closeRequest(); });
		...
		// GUI Area 4
		setupButtonUI(button_ManageInvitations, "Dialog", 16, 210, Pos.CENTER, 20, 270);
		button_ManageInvitations.setOnAction((event) -> 
			{ControllerAdminHome.manageInvitations(); });
	
		setupButtonUI(button_SetOnetimePassword, "Dialog", 16, 210, Pos.CENTER, 20, 320);
		button_SetOnetimePassword.setOnAction((event) -> 
			{ControllerAdminHome.setOnetimePassword(); });

		setupButtonUI(button_DeleteUser, "Dialog", 16, 210, Pos.CENTER, 20, 370);
		button_DeleteUser.setOnAction((event) -> {ControllerAdminHome.deleteUser(); });

		setupButtonUI(button_ListUsers, "Dialog", 16, 210, Pos.CENTER, 20, 420);
		button_ListUsers.setOnAction((event) -> {ControllerAdminHome.listusers(); });

		setupButtonUI(button_AddRemoveRoles, "Dialog", 16, 210, Pos.CENTER, 20, 470);
		button_AddRemoveRoles.setOnAction((event) -> {ControllerAdminHome.addRemoveRoles(); });
		
		setupButtonUI(button_ViewPosts, "Dialog", 16, 210, Pos.CENTER, 300, 270);
		button_ViewPosts.setOnAction((event) -> {ControllerAdminHome.viewPosts(); });
		
		setupButtonUI(button_CreatePostReply, "Dialog", 16, 210, Pos.CENTER, 300, 320);
		button_CreatePostReply.setOnAction((event) -> {ControllerAdminHome.createPostReply(); });
		
		setupButtonUI(button_EditPostReply, "Dialog", 16, 210, Pos.CENTER, 300, 370);
		button_EditPostReply.setOnAction((event) -> {ControllerAdminHome.editPostReply(); });
		
		setupButtonUI(button_DeletePostReply, "Dialog", 16, 210, Pos.CENTER, 300, 420);
		button_DeletePostReply.setOnAction((event) -> {ControllerAdminHome.deletePostReply(); });
		
		setupButtonUI(button_ManageThreads, "Dialog", 16, 210, Pos.CENTER, 300, 470);
		button_ManageThreads.setOnAction((event) -> {ControllerAdminHome.manageThreads(); });
		
		setupButtonUI(button_ViewParameters, "Dialog", 16, 210, Pos.CENTER, 570, 270);
		button_ViewParameters.setOnAction((event) -> {ControllerAdminHome.viewParameters(); });
		
		setupButtonUI(button_ManageParameters, "Dialog", 16, 210, Pos.CENTER, 570, 320);
		button_ManageParameters.setOnAction((event) -> {ControllerAdminHome.manageParameters(); });
		
		setupButtonUI(button_ViewGrades, "Dialog", 16, 210, Pos.CENTER, 570, 370);
		button_ViewGrades.setOnAction((event) -> {ControllerAdminHome.viewGrades(); });
		
		setupButtonUI(button_ManageGrades, "Dialog", 16, 210, Pos.CENTER, 570, 420);
		button_ManageGrades.setOnAction((event) -> {ControllerAdminHome.manageGrades(); });
		...
		theRootPane.getChildren().addAll(
    		...
    		button_Quit,
    		button_ViewPosts,
    		button_CreatePostReply,
    		button_EditPostReply,
    		button_DeletePostReply,
    		button_ManageThreads,
    		button_ViewParameters,
    		button_ManageParameters, 
    		button_ViewGrades, button_ManageGrades,
    		button_ViewRequests, button_CloseRequest
    		);
	...
	*/
	...
	public static String getOTPUsername() {
		TextInputDialog dialog = new TextInputDialog();
		dialog.setTitle("One-Time Password");
		dialog.setHeaderText("Enter the user to get OTP for");
