...
public class ViewFirstAdmin {
	...
	protected static Label label_Password1Error = new Label();
	protected static Label label_Password2Error = new Label();
	...
	private ViewFirstAdmin() {
		...
		setupLabelUI(label_Password1Error, "Arial", 18, width, Pos.CENTER, 0, 360);
		
		setupLabelUI(label_Password2Error, "Arial", 18, width, Pos.CENTER, 0, 390);
		...
		theRootPane.getChildren().addAll(label_ApplicationTitle, label_TitleLine1,
				...
				button_Quit, label_UsernameError, label_Password1Error, 
				label_Password2Error);
	}
