...
public class Model {
	...
	public static boolean foundShortEnough = true;     // Added boolean variable
	...
	private static void updateFlags() {
		...
		if (foundShortEnough) {
			View.label_ShortEnough.setText("Less than 32 characters - Satisfied");
	...
	public static String evaluatePassword(String input) {
		...
		while (running) {
			...
			if (currentCharNdx > 32) {                                 // Added if statement to ensure password is no longer than 32 chars
