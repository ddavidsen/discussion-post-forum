...
public class View {
	...
	public static void view (Pane theRoot) {
	    ...
	    setupLabelWidget(label_ShortEnough, 30, 330, "Arial", 14, windowWidth-10,   // Position 330, because they are all in increments of 30
				Pos.BASELINE_LEFT);
		...
		setupLabelWidget(validPassword, 10, 370, "Arial", 18, windowWidth-150-10,   // Changed 340 to 370, due to needing more lines for the various requirements
				Pos.BASELINE_LEFT);
		...
		setupButtonWidget(button_Finish, "Finish and Save The Password", (windowWidth-250)/2,
				410, "Arial", 14, 250, Pos.BASELINE_CENTER);                        // Changed 380 to 410, due to needing more lines for the various requirements
	...
	static protected void resetAssessments() {
	    ...
	    label_ShortEnough.setText("At most 32 characters - Not yet satisfied");
